...
import random
import requests
from CONF import CONF_DB, CONF_PROXY


def db():
    client = MongoClient(CONF_DB)
    tn = client.tunisie
...
def get_proxy():
    ...
    url = "https://api.proxicity.io/v2/" + str(CONF_PROXY) + "/proxy?protocol=http&country=FR&httpsSupport=true"
